...
function translateLegacyUi() {
  ...
  document.querySelectorAll("input[placeholder]").forEach((input) => { input.placeholder = input.placeholder.replace("Search by name or email", "Keresés név vagy e-mail alapján"); });
}
